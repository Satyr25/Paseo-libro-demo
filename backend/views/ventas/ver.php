                        ...
                        <table style="width: 80%">
                            ...
                            <tr>
                                <td style="font-size:13px;height:20px;padding-top: 5px;">
                                    ...
                                    <span class="info-table gray">$<?= $libro->preciovp ?></span>
                                    <hr class="lib-hr">
                                </td>
                            </tr>
                            <?php $totaldes = $totaldes + ($libro->preciovp * $libro->cantidad); $totalcan = $totalcan + $libro->total; $total_libros += $libro->cantidad; ?>
                        </table>
                    </td>
