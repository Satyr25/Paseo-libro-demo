...
<div class="container container-confirmacion">
    ...
    <div id="cuerpoconfir" class="row checkout-block check-card-block"> 
        <div class="col-xs-12">
            <p class="confirmacion-titulo">¡Pendiente de Pago!</p>
        </div>
        <div class="col-xs-12 confirmacion-texto">
            Cuando se realize el pago se enviará un correo a <?= $correo ?>. En caso de que no aparezca revisa en tu carpeta de spam.
        </div>
    ...
    <div class="row">
        <div class="col-md-offset-5 col-md-2">
            <a href="<?= Url::to(['checkout/report', 'referencia' => ($referencia), 'monto' => ($monto)]); ?>" target="_blank" class="backHome" style="margin-top: 10px;">Imprimir Ficha</a>
        </div>
    </div>
    <div class="row">
        <div class="col-xs-12">
