...
$portada = Url::base(true).'/images/portada_default.jpg';
$totalp = 0;
$totales = 0;
$cantes =0;
$cantidades = 0;
            ...
            <tr style="height: 300px;">
                <td style="padding:0 0 0 15px;color: #2b323b;width: 30%;">
                    <?php if($libros[$i][0] == $foto['id'] && $foto['portada']){ ?>
                        <img src="<?=Url::base(true)?>/images/<?php print_r($foto['portada']) ?>" style="width:90%;float: right; max-width:220px; padding-right:20px;">
                    <?php } else {?>
