...
?>
<?php
$logo = 'https://www.uppl.blackrobot.mx/images/logo-uppl-correo.png';
$logofedex = 'https://www.uppl.com.mx/images/Fedex.png';
$portada = 'https://www.uppl.com.mx/images/PortadaNoDisponible.png';
$totalp = 0;
$totales = 0;
$cantes =0;
$cantidades = 0;
            ...
            <tr style="height: 300px;">
                <td style="padding:0 0 0 15px;color: #2b323b;width: 30%;">
                    <?php if($libros[$i][0] == $foto['id'] && $foto['portada']){ ?>
                        <img src="https://www.uppl.com.mx/images/<?php print_r($foto['portada']) ?>" style="width:90%;float: right; max-width:220px; padding-right:20px;">
                    <?php } else {?>
                ...
                <tr>
                    <td style="padding:0 0 0 15px;color: #2b323b;width: 120px;">
                        <?php if($libros[$i]->id == $foto['id'] && $foto['portada']){ ?>
                            <img src="https://www.uppl.com.mx/images/<?php print_r($foto['portada']) ?>" style="width:100px;float: left;">
                        <?php } else {?>
        ...
        <div style="width:350px; margin:0 auto 20px;">
            <table style="table-layout:fixed; width:350px; border-collapse:collapse;">
                <tbody>
                    ...
                    <tr style="border-bottom: 2px solid #f4f6f6; height: 30px;">
                        <td style="width:50%; color:#0b4066; font-weight: bold;">Subtotal:</td>
                        <td style="float: right; padding:10px 0; width:50%;">$<?= number_format($totalp-$precio_envio, 2)  ?></td>
                    </tr>
                    <tr style="border-bottom: 2px solid #f4f6f6; height: 30px;">
                    ...
                    <tr style="height: 30px;">
                        ...
                        <td style="float: right; padding:10px 0; width:50%; font-weight:bold;"><?= number_format($totalp, 2) ?></td>
                    </tr>
                </tbody>
            </table>
        </div>
