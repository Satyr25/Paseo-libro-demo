...
<div style="background-color: #f9f9f9;color: #333;">
    ...
    <div style="font-size:19px;padding-top:0px;padding-bottom:20px; text-align: center; font-family: 'Raleway' ">
        <?php if($pedido_oxxo){
            echo 'Pago Pendiente Oxxo'; 
        }elseif($test){ 
            echo 'Gracias por tu compra en Lectorum'; 
        }else{
            echo 'Gracias por tu compra en Lectorum'; 
        } ?>
    </div>
...
<div style="background-color: #e2e2e3;color:#333;" class="body-container" style="font-family: 'Raleway', sans-serif;font-weight: 600;line-height: 1;font-size: 14px;color: #333333;">
    ...
    <div style="background-color: #fff; margin-left: 50px; margin-right: 50px; padding-bottom: 40px;">
        <div style="text-align: center; padding-top: 20px; font-size: 12px;">
            <p class="tit-venta" style="font-size: 25px;color: #1f5b5f !important;">Detalle de Pedido: <?= $dia_now ?> de <?= $mes_now ?> de <?= $anio_now ?> a las <?= $hora_now ?> hrs.</p>
        </div>
        <table class="vent-table" style="margin: 5% auto;width: 80%;">
            <thead>
                ...
                <th class="tit-princ" style="text-align: left;padding-top: 15px;padding: 0;font-weight: 600 !important;color: #333;text-align: right;font-size: 20px;font-weight: 600 !important;">
                    Subtotal
                </th>
            </thead>
                <?php  
        ...
        <table class="dat-compr" style="width: 100%;background-color: #f4f6f6;">
            <tr>
                <td class="left-data" style="padding-top: 15px;padding: 0;font-weight: 600 !important;color: #333;text-align: left;padding-left: 10%;width: 50%;border-right: 1px solid #d1d1d1;padding-top: 5%;">
                    ...
                    <?php if($num_guia){  ?>
                        ...
                        <div class="btnVerguia" style="border-radius: 2px;position: relative;background-color: #379fa2;padding: 8px 0px;width: 30%;margin: 0;font-weight: bold;margin-bottom: 15px;text-align: center;">
                                <a href="https://www.fedex.com/apps/fedextrack/?action=track&trackingnumber=<?= $num_guia ?>" target="_blank" style="color: #fff;font-size: 12px;text-decoration: none;">Estatus de Seguimiento</a>
                        </div>
                    <?php }else{ ?>
                ...
                <td rowspan="2" class="right-data" style="padding-top: 15px;padding: 0;font-weight: 600 !important;color: #333;text-align: left;padding-left: 2%;padding-top: 5%;">
                    <span class="tit-princ" style="font-size: 20px;font-weight: 600 !important;">Información de Contacto</span>
                    ...
                    <p style="margin:12px 0;"><span class="sp-marg" style="width: 20%;display: inline-block;min-width: 80px;color: #999;font-weight: 600 !important">Domicilio: </span><span class="blvk" style="color: #333;font-weight: normal!important;text-transform: capitalize;"><?= $clientes->calle.' '.$clientes->num_ext  ?> <?php if($clientes->num_int){ echo('int '.$clientes->num_int); } ?></span></p>
                    <hr class="datos-hr" style="margin-top: 7px;margin-bottom: 7px;width: 80%;margin-right: 20%;">
